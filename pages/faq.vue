...
v-container(fluid)
  ...
  v-row
    v-col(cols='12', lg='6')
      ...
      client-only
        template(
          v-if='submitted || $globals.contentRequests.includes($store.getters["localStorage/USER_ID"])'
        )
          p
        ...
        template(v-else)
          ...
          button.button.button-red(@click='$requestContent(country); submitted = true') SUBMIT
    v-col(cols='12', lg='6')
